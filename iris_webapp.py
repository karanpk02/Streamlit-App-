...
import pickle
log_model = pickle.load(open('https://github.com/karanpk02/Streamlit-App-/blob/main/log_model.pkl?raw=true','rb'))
rf_model = pickle.load(open('https://github.com/karanpk02/Streamlit-App-/blob/main/rf_model.pkl?raw=true','rb'))
def classify(num):
    if num<0.5:
        return "setosa"
    elif num<1.5:
